...
urlpatterns = [
    ...
    path('process_actual/<int:orderid>/<str:type>/<int:customerid>', views.process_actualView, name='process_actualView'),
    path('process_actual_save/<int:orderid>/<str:type>/<int:customerid>', views.process_actual_saveView, name='process_actual_saveView'),
